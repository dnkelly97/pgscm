...
@scenario("../../feature/student/update_demographics.feature",
          "Send out Demographics Form to Prospective Student")
def test_demographics(live_server):
    pass


@given("I am an Administrator")
def demographics_setup(live_server, browser):
...
def send_email(browser):
    browser.find_element_by_id("demographics_email_button").click()
...
def access_form(live_server, browser):
    browser.get(live_server + "/student/demographics/test@test.com")
    assert "Test" in browser.page_source


@scenario("../../feature/student/update_demographics.feature",
          "Access Demographics Form")
def test_access_to_form(live_server):
    pass


@when("I go to Demographics Form Page")
