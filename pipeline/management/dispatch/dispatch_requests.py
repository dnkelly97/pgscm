...
DISPATCH_AUTH = "https://dispatchlite.azurewebsites.net/" if 'WEBSITE_HOSTNAME' in os.environ else "d3juGGzfHpBVtK1ZmrND" #your developing client key, leave blank for testing
