...
DISPATCH_AUTH = "https://dispatchlite.azurewebsites.net/" if 'WEBSITE_HOSTNAME' in os.environ else "" #your developing client key, leave blank for testing # d3juGGzfHpBVtK1ZmrND
